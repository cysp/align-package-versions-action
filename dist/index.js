...
const align_package_versions_1 = __nccwpck_require__(7092);
async function main() {
    const config = await (0, align_package_versions_1.loadConfiguration)();
    if (!config) {
        core.debug("No configuration found.");
        return;
    }
    const packageJsons = await (0, align_package_versions_1.loadWorkspacePackageJsons)(".", ".");
    let anyModified = false;
    for (const pattern of config.patterns) {
        core.info(`${pattern}`);
        const [modified, version] = (0, align_package_versions_1.alignPackageVersions)(packageJsons, pattern);
        if (modified) {
            core.info(`  ${version}`);
        }
        else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.alignPackageVersions = void 0;
const find_package_versions_1 = __nccwpck_require__(6746);
const set_package_versions_1 = __nccwpck_require__(9076);
function alignPackageVersions(packageJsons, pattern) {
    const version = (0, find_package_versions_1.findGreatestPackageVersion)(packageJsons, pattern);
    if (!version) {
        return [false, null];
    }
    let modified = false;
    for (const packageJson of packageJsons) {
        modified ||= (0, set_package_versions_1.setPackageVersions)(packageJson, pattern, version);
    }
    return [modified, version];
}
exports.alignPackageVersions = alignPackageVersions;
...
const schema = zod_1.z.object({
    patterns: zod_1.z.array(zod_1.z.string().transform((s) => new RegExp(s))),
});
async function loadConfiguration() {
    const cc = (0, cosmiconfig_1.cosmiconfig)("align-package-versions");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.findPackageVersions = exports.findGreatestPackageVersion = void 0;
const semver_1 = __importDefault(__nccwpck_require__(1383));
function findGreatestPackageVersion(packageJsons, pattern) {
    ...
    return vv.reduce((acc, cur) => {
        if (semver_1.default.gt(cur, acc)) {
            return cur;
        }
        return acc;
    }, v);
}
exports.findGreatestPackageVersion = findGreatestPackageVersion;
function findPackageVersions(packageJsons, pattern) {
    return packageJsons.flatMap((packageJson) => findPackageVersions_(packageJson, pattern) ?? []);
}
exports.findPackageVersions = findPackageVersions;
function findPackageVersions_(packageJson, pattern) {
    const versions = [];
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setPackageVersions = exports.loadWorkspacePackageJsons = exports.findPackageVersions = exports.findGreatestPackageVersion = exports.loadConfiguration = exports.alignPackageVersions = void 0;
var align_package_versions_1 = __nccwpck_require__(1718);
Object.defineProperty(exports, "alignPackageVersions", ({ enumerable: true, get: function () { return align_package_versions_1.alignPackageVersions; } }));
var cosmiconfig_1 = __nccwpck_require__(8529);
Object.defineProperty(exports, "loadConfiguration", ({ enumerable: true, get: function () { return cosmiconfig_1.loadConfiguration; } }));
var find_package_versions_1 = __nccwpck_require__(6746);
Object.defineProperty(exports, "findGreatestPackageVersion", ({ enumerable: true, get: function () { return find_package_versions_1.findGreatestPackageVersion; } }));
Object.defineProperty(exports, "findPackageVersions", ({ enumerable: true, get: function () { return find_package_versions_1.findPackageVersions; } }));
var package_json_1 = __nccwpck_require__(3658);
Object.defineProperty(exports, "loadWorkspacePackageJsons", ({ enumerable: true, get: function () { return package_json_1.loadWorkspacePackageJsons; } }));
var set_package_versions_1 = __nccwpck_require__(9076);
Object.defineProperty(exports, "setPackageVersions", ({ enumerable: true, get: function () { return set_package_versions_1.setPackageVersions; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.workspacePatternsFromPackageJson = exports.loadWorkspacePackageJsons = void 0;
const node_path_1 = __importDefault(__nccwpck_require__(9411));
const package_json_1 = __importDefault(__nccwpck_require__(1899));
const globby_1 = __importDefault(__nccwpck_require__(3398));
async function loadWorkspacePackageJsons(cwd, packageJsonPath) {
    const base = await package_json_1.default.load(packageJsonPath);
    const workspacePatterns = workspacePatternsFromPackageJson(base) ?? [];
    const workspacePaths = await (0, globby_1.default)(workspacePatterns, {
        cwd: node_path_1.default.join(cwd, packageJsonPath),
        onlyDirectories: true,
        expandDirectories: false,
    });
    const workspaces = (await Promise.all(workspacePaths.flatMap((workspacePath) => loadWorkspacePackageJsons(node_path_1.default.join(cwd, packageJsonPath), workspacePath)))).flat();
    return [base, ...workspaces];
}
exports.loadWorkspacePackageJsons = loadWorkspacePackageJsons;
function workspacePatternsFromPackageJson(packageJson) {
...
exports.workspacePatternsFromPackageJson = workspacePatternsFromPackageJson;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setPackageVersions = void 0;
function setPackageVersions(packageJson, pattern, version) {
    let modified = false;
    for (const type of ["devDependencies", "dependencies"]) {
...
exports.setPackageVersions = setPackageVersions;
...
const updateDeps = __nccwpck_require__(9407)
const updateScripts = __nccwpck_require__(2748)
const updateWorkspaces = __nccwpck_require__(29)

const parseJSON = __nccwpck_require__(5054)
...
const merge2 = __nccwpck_require__(2578);
const fastGlob = __nccwpck_require__(3664);
const dirGlob = __nccwpck_require__(4780);
...
const fallback = __nccwpck_require__(9605);
const {default: LinesAndColumns} = __nccwpck_require__(3042);
const {codeFrameColumns} = __nccwpck_require__(1322);
